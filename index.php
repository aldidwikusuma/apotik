						...
						foreach ($ambil as $tampung) {?>
							<div class="col-md-3">
								<div class="card shadow p-3 mb-5 bg-white rounded">
									<img src="images/<?php echo $tampung['gambar']; ?>" alt="<?php echo $tampung['gambar']; ?>" class="card-img-top img-fluid" >
									<div class="card-body">
										<h5 class="card-title"><?php echo $tampung['nm_obat']?></h5>
										<p class="card-text">Rp. <?= $tampung['harga']?></p>
										<a href="detail-obat.php?kd=<?php echo $tampung['kd_obat']; ?>" class="btn btn btn-outline-primary">Detail</a>
									</div>
								</div>
							</div>
							<?php
