                ...
                <div class="table-responsive">
                    ...
                    <thead>
                        ...
                        if ($txtcari == !"") {
                            ...
                            $a = $_SESSION['id'];
                            $query = mysqli_query($conn, "SELECT * FROM tbl_transaksi, tbl_user, tbl_obat WHERE tbl_transaksi.id_user = tbl_user.id_user AND tbl_transaksi.kd_obat = tbl_obat.kd_obat AND tbl_user.id_user='$a' ORDER BY tbl_transaksi.kd_transaksi DESC");
                        }
