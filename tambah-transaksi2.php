<?php 
	...
	$query = mysqli_query($conn, "SELECT * FROM tbl_transaksi, tbl_user, tbl_obat WHERE tbl_transaksi.id_user = tbl_user.id_user AND tbl_transaksi.kd_obat = tbl_obat.kd_obat AND kd_transaksi = '$kd_trs'");
...
<head>
	...
	<script src="js/jquery.js"></scripalert>
						...
						<form action="" method="post" enctype="multipart/form-data">
                            ...
                            <div class="form-group">
                                <?php 
 						        ...
 						        ?>
								 <center>
 						            <img src="images/a/bri.png" width="100px" align="center">
									 </center>
 						        <?php
 					            }elseif ($t['pembayaran'] == "BNI") {
 						        ?>
								 <center>
 						            <img src="images/a/bni.png" width="100px" align="center">
									 </center>
 						        <?php
 					            }elseif ($t['pembayaran'] == "BCA") {
 						        ?>
								 <center>
 						            <img src="images/a/bca.png" width="100px" align="center">
									 </center>
 						        <?php
 					            }elseif ($t['pembayaran'] == "MANDIRI") {
 						        ?>
								 <center>
 						            <img src="images/a/mandiri.png" width="100px" align="center">
									 </center>
 						        <?php
 					                }
 				                ?> 
